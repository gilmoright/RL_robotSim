...
if __name__=="__main__":
    ...
    with open(EXPERIMENT_DIR + "/params_on35.json", "r") as f:
        CONFIG = json.load(f)
    ...
    table_save_path = EXPERIMENT_DIR + "/checkpoint-{}_test_on35.csv".format(args.checkpoint_number)
    ...
    monitor_env = gym.wrappers.Monitor(env=env,
                                    directory= os.path.dirname(checkpoint_path)+"/videos_on35",
