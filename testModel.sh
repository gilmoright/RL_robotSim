...
RUN_DIR=/s/ls4/users/slava1195/c/RL_robotSim/results/FollowerContinuous/env8/PPO/feats_v12_train/ppo_env8feats_v12_train5v7/PPO_continuous-grid_52abf_00000_0_2022-11-17_16-54-15


python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 010
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 020
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 030
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 040
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 050
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 060
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 070
