...
--run_dir $RUN_DIR \
--checkpoint_number 000010
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000020
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000030
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000040
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000050
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000060
python TestModel.py --rlalgo PPO \
--run_dir $RUN_DIR \
--checkpoint_number 000070
