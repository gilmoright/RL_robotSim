...
#### 08.02.2023
python MyTrain.py --config-file /s/ls4/users/slava1195/rl_robots/RL_robotSim/Configs/FollowerContinuous/PPO_dyn_obst.conf --experiments ppo_env21v1_feats_v15_lstmv7v2 ppo_env21v2_feats_v15_lstmv7v2 ppo_env21v1_feats_v15_v5v7_sqd
