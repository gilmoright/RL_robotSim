...
#### 17.02.2023
python MyTrain.py --config-file Configs/FollowerContinuous/PPO_dyn_obst.conf --experiments ppo_sv1_env24v1_feats_v16_fi_v5v8_sqd ppo_sv2_env24v1_feats_v17_fi_v5v8_sqd ppo_sv1_env24v1_feats_v17_fi_v5v8_sqd
