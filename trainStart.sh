...
python MyTrain.py --config-file Configs/FollowerContinuous/PPO_dyn_obst.conf --experiments ppo_env11v1_feats_v12_train5v7 ppo_env11v2_feats_v12_train5v7 ppo_env11v3_feats_v12_train5v7
